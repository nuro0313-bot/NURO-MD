const {
  ...
  const l = console.log
  const { getBuffer, getGroupAdmins, getRandom, h2k, isUrl, Json, run)time, sleep, fetchJson } = require('./lib/functions')
...
const sessdata = config.SESSION_ID.replace("NURO-MD~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `╭━━━━👋 *HELLO DEAR*━━━━╮\n\n┃➢*THIS IS NURO MD CONNECTED MASSEGE🍃✨*\n\n┃➢*YOUR PREFIX=${prefix}*\n\n┃➢*OWNER NUM=94721017862*\n┃\n└━━━━━━━━━━`;
