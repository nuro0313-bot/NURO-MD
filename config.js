...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY NURO-MD 🤍*",
// set the auto reply massage on status reply  
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "NURO-MD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "NURO-MD",
...
ALIVE_MSG: process.env.ALIVE_MSG || "👋 HELLO I AM ONLINE NOW💝🍃\n> HI I AM *NURO-MD*⚡",
// add alive msg here 
...
DEV: process.env.DEV || "94721017862",
